...
public class CompletePipeline {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //      Cumulate the sum from each batch every thirty seconds
        JavaPairDStream<String, Integer> wordCounts = pairs.reduceByKey(
                (Function2<Integer, Integer, Integer>) (i1, i2) -> i1 + i2
        );

        //      Cumulate the sum from each batch every thirty seconds
        JavaPairDStream<String, Integer> wordCounts2 = pairs.reduceByKeyAndWindow(
                (Function2<Integer, Integer, Integer>) (i1, i2) -> i1 + i2
                , Durations.milliseconds(30000)
                , Durations.milliseconds(30000)
        );
