    ...
    public void pullBasedApproachSimpleSink1() {
        try {
            ...
            JavaReceiverInputDStream<String> lines =
                    ssc.receiverStream((Receiver)DSPConnectorFactory.getInstance().createSourceConnector(new DSPConnectorConfig.Builder("localhost", 9665)
                            .withDSP("spark")
            ...
            pairs.foreachRDD((VoidFunction)DSPConnectorFactory.getInstance().createSinkConnector(new DSPConnectorConfig.Builder("localhost", 9656)
                    .withDSP("spark")
                    .withHWM(20)
                    .withTimeout(10000)
                    .build()));
