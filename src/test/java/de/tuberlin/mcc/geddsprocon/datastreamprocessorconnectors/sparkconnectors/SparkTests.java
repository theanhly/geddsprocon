...
public class SparkTests {
    ...
    public void pullBasedApproachSink1() {
        try {
            ...
            pairs.foreachRDD((VoidFunction)new DSPConnectorFactory<>().createSinkConnector(new DSPConnectorConfig.Builder("localhost", 9656)
                    .withDSP("spark")
                    .withTimeout(10000)
                    .build()));
    ...
    public void pullBasedApproachSource1() {
        try {
            ...
            // Create an input stream with the custom receiver on target ip:port and count the
            // words in input stream of \n delimited text (eg. generated by 'nc')
            JavaReceiverInputDStream<Tuple2<String, Integer>> tuples = ssc.receiverStream((Receiver)new DSPConnectorFactory<>().createSourceConnector(new DSPConnectorConfig.Builder("localhost", 9656)
