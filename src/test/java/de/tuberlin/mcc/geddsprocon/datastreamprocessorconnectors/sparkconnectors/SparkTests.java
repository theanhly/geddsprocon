    ...
    public void pullBasedApproachSink1() {
        try {
            ...
            JavaReceiverInputDStream<String> lines =
                    ssc.receiverStream((Receiver)DSPConnectorFactory.getInstance().createSourceConnector(new DSPConnectorConfig.Builder("localhost", 9655)
                            .withDSP("spark")
            ...
            pairs.foreachRDD((VoidFunction)DSPConnectorFactory.getInstance().createSinkConnector(new DSPConnectorConfig.Builder("localhost", 9666)
                    .withDSP("spark")
                    .withTimeout(10000)
                    .build()));
