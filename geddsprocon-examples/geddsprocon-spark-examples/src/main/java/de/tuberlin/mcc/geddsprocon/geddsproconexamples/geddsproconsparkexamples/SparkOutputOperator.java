...
public class SparkOutputOperator {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        JavaReceiverInputDStream<String> lines =
                ssc.receiverStream((Receiver)DSPConnectorFactory.getInstance().createSourceConnector(new DSPConnectorConfig.Builder("192.168.56.102", 9665)
                        .withDSP("spark")
        ...
        pairs.foreachRDD((VoidFunction)DSPConnectorFactory.getInstance().createSinkConnector(new DSPConnectorConfig.Builder("192.168.56.102", 9656)
                .withDSP("spark")
                .withHWM(20)
